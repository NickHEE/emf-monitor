...
const char widtbl_f64[96] =          // character width table
{
...
const char chr_f64_20[96] =          // 2 bytes per row
{
...
const char chr_f64_2D[144] =         // 3 bytes per row
{
...
const char chr_f64_2E[144] =         // 3 bytes per row
{
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,    // row 1 - 4
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,    // row 5 - 8
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,    // row 9 - 12
...
const char chr_f64_30[192] =         // 4 bytes per row
{
...
const char chr_f64_31[192] =         // 4 bytes per row
{
...
const char chr_f64_32[192] =         // 4 bytes per row
{
...
const char chr_f64_33[192] =         // 4 bytes per row
{
        0x00, 0x00, 0x00, 0x00, 0x00, 0x7F, 0x80, 0x00, 0x03, 0xFF, 0xF0, 0x00,    // row 1 - 3
...
const char chr_f64_34[192] =         // 4 bytes per row
{
...
const char chr_f64_35[192] =         // 4 bytes per row
{
...
const char chr_f64_36[192] =         // 4 bytes per row
{
...
const char chr_f64_37[192] =         // 4 bytes per row
{
...
const char chr_f64_38[192] =         // 4 bytes per row
{
...
const char chr_f64_39[192] =         // 4 bytes per row
{
...
const char chr_f64_3A[144] =         // 3 bytes per row
{
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,    // row 1 - 4
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,    // row 5 - 8
...
const char chr_f64_61[192] =         // 4 bytes per row
{
...
const char chr_f64_6D[288] =         // 6 bytes per row
{
...
const char chr_f64_70[192] =         // 4 bytes per row
{
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,    // row 1 - 3
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,    // row 4 - 6
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,    // row 7 - 9
...
const char * const chrtbl_f64[96] =        // character pointer table
{
