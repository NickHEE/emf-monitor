...
//const char widtbl_f32[96] =         // character width table
const char widtbl_f32[96] =         // character width table
{
...
const char chr_f32_20[] =         // 1 byte per row
{
...
const char chr_f32_21[] =         // 2 bytes per row
{
           // row 1 - 6
...
const char chr_f32_22[] =         // 2 bytes per row
{
           // row 1 - 6
...
const char chr_f32_23[] =         // 3 bytes per row
{
           // row 1 - 4
...
const char chr_f32_24[] =         // 3 bytes per row
{
           // row 1 - 4
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00,    // row 5 - 8
...
const char chr_f32_25[] =         // 3 bytes per row
{
           // row 1 - 4
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00,    // row 5 - 8
...
const char chr_f32_26[] =         // 3 bytes per row
{
           // row 1 - 4
...
const char chr_f32_27[] =         // 2 bytes per row
{
           // row 1 - 6
...
const char chr_f32_28[] =         // 2 bytes per row
{
           // row 1 - 6
...
const char chr_f32_29[] =         // 2 bytes per row
{
...
const char chr_f32_2A[] =         // 2 bytes per row
{
           // row 1 - 6
...
const char chr_f32_2B[] =         // 2 bytes per row
{
           // row 1 - 6
...
const char chr_f32_2C[] =         // 2 bytes per row
{
           // row 1 - 6
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,    // row 7 - 12
...
const char chr_f32_2D[] =         // 2 bytes per row
{
           // row 1 - 6
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,    // row 7 - 12
...
const char chr_f32_2E[] =         // 2 bytes per row
{
           // row 1 - 6
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,    // row 7 - 12
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,    // row 13 - 18
...
const char chr_f32_2F[] =         // 2 bytes per row
{
           // row 1 - 6
...
const char chr_f32_30[] =         // 3 bytes per row
{
           // row 1 - 4
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00,    // row 5 - 8
...
const char chr_f32_31[] =         // 3 bytes per row
{
           // row 1 - 4
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00,    // row 5 - 8
...
const char chr_f32_32[] =         // 3 bytes per row
{
           // row 1 - 4
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00,    // row 5 - 8
...
const char chr_f32_33[] =         // 3 bytes per row
{
           // row 1 - 4
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00,    // row 5 - 8
...
const char chr_f32_34[] =         // 3 bytes per row
{
           // row 1 - 4
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00,    // row 5 - 8
...
const char chr_f32_35[] =         // 3 bytes per row
{
           // row 1 - 4
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00,    // row 5 - 8
...
const char chr_f32_36[] =         // 3 bytes per row
{
           // row 1 - 4
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00,    // row 5 - 8
...
const char chr_f32_37[] =         // 3 bytes per row
{
           // row 1 - 4
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00,    // row 5 - 8
...
const char chr_f32_38[] =         // 3 bytes per row
{
           // row 1 - 4
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00,    // row 5 - 8
...
const char chr_f32_39[] =         // 3 bytes per row
{
           // row 1 - 4
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00,    // row 5 - 8
...
const char chr_f32_3A[] =         // 2 bytes per row
{
           // row 1 - 6
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,    // row 7 - 12
...
const char chr_f32_3B[] =         // 2 bytes per row
{
           // row 1 - 6
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,    // row 7 - 12
        0x38, 0x00, 0x38, 0x00, 0x38, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,    // row 13 - 18
...
const char chr_f32_3C[] =        // 3 bytes per row
{
           // row 1 - 3
           // row 4 - 6  I                 I
...
const char chr_f32_3D[] =         // 2 bytes per row
{
           // row 1 - 6
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,    // row 7 - 12
...
const char chr_f32_3E[] =        // 4 bytes per row
{
           // row 1 - 3
           // row 4 - 6        I                       I
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,    // row 7 - 9
...
const char chr_f32_3F[] =         // 2 bytes per row
{
           // row 1 - 6
...
const char chr_f32_40[] =        // 4 bytes per row
{
           // row 1 - 3
           // row 4 - 6
...
const char chr_f32_41[] =         // 3 bytes per row
{
           // row 1 - 4
...
const char chr_f32_42[] =         // 3 bytes per row
{
           // row 1 - 4
...
const char chr_f32_43[] =         // 3 bytes per row
{
           // row 1 - 4
...
const char chr_f32_44[] =         // 3 bytes per row
{
           // row 1 - 4
...
const char chr_f32_45[] =         // 3 bytes per row
{
           // row 1 - 4
...
const char chr_f32_46[] =         // 3 bytes per row
{
           // row 1 - 4
...
const char chr_f32_47[] =         // 3 bytes per row
{
           // row 1 - 4
        0x00, 0x00, 0x00, 0x03, 0xF8, 0x00,    // row 5 - 8
...
const char chr_f32_48[] =         // 3 bytes per row
{
           // row 1 - 4
...
const char chr_f32_49[] =         // 2 bytes per row
{
           // row 1 - 6
...
const char chr_f32_4A[] =         // 2 bytes per row
{
           // row 1 - 6
...
const char chr_f32_4B[] =         // 3 bytes per row
{
           // row 1 - 4
...
const char chr_f32_4C[] =         // 2 bytes per row
{
           // row 1 - 6
        0x00, 0x00, 0x30, 0x00, 0x30, 0x00, 0x30, 0x00, 0x30, 0x00, 0x30, 0x00,    // row 7 - 12
        0x30, 0x00, 0x30, 0x00, 0x30, 0x00, 0x30, 0x00, 0x30, 0x00, 0x30, 0x00,    // row 13 - 18
...
const char chr_f32_4D[] =         // 3 bytes per row
{
           // row 1 - 4
...
const char chr_f32_4E[] =         // 3 bytes per row
{
           // row 1 - 4
...
const char chr_f32_4F[] =         // 3 bytes per row
{
           // row 1 - 4
        0x00, 0x00, 0x00, 0x03, 0xF8, 0x00,    // row 5 - 8
...
const char chr_f32_50[] =         // 3 bytes per row
{
           // row 1 - 4
        0x00, 0x00, 0x00, 0x3F, 0xF8, 0x00,    // row 5 - 8
...
const char chr_f32_51[] =         // 3 bytes per row
{
           // row 1 - 4
        0x00, 0x00, 0x00, 0x03, 0xF8, 0x00,    // row 5 - 8
        0x0F, 0xFE, 0x00, 0x1E, 0x0F, 0x00, 0x38, 0x03, 0x80, 0x30, 0x01, 0x80,    // row 9 - 12
...
const char chr_f32_52[] =         // 3 bytes per row
{
           // row 1 - 4
        0x00, 0x00, 0x00, 0x3F, 0xFC, 0x00,    // row 5 - 8
...
const char chr_f32_53[] =         // 3 bytes per row
{
           // row 1 - 4
...
const char chr_f32_54[] =         // 3 bytes per row
{
           // row 1 - 4
...
const char chr_f32_55[] =         // 3 bytes per row
{
           // row 1 - 4
        0x00, 0x00, 0x00, 0x30, 0x03, 0x00,    // row 5 - 8
        0x30, 0x03, 0x00, 0x30, 0x03, 0x00, 0x30, 0x03, 0x00, 0x30, 0x03, 0x00,    // row 9 - 12
...
const char chr_f32_56[] =         // 3 bytes per row
{
           // row 1 - 4
...
const char chr_f32_57[] =        // 4 bytes per row
{
           // row 1 - 3
           // row 4 - 6
...
const char chr_f32_58[] =         // 3 bytes per row
{
           // row 1 - 4
...
const char chr_f32_59[] =         // 3 bytes per row
{
           // row 1 - 4
...
const char chr_f32_5A[] =         // 3 bytes per row
{
           // row 1 - 4
        0x00, 0x00, 0x00, 0x3F, 0xFE, 0x00,    // row 5 - 8
...
const char chr_f32_5B[] =         // 2 bytes per row
{
           // row 1 - 6
...
const char chr_f32_5C[] =         // 2 bytes per row
{
           // row 1 - 6
...
const char chr_f32_5D[] =         // 2 bytes per row
{
           // row 1 - 6
...
const char chr_f32_5E[] =        // 2 bytes per row
{
           // row 1 - 3
           // row 4 - 6        I                       I
...
const char chr_f32_5F[] =         // 2 bytes per row
{
           // row 1 - 6
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,    // row 7 - 12
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,    // row 13 - 18
...
const char chr_f32_60[] =         // 2 bytes per row
{
           // row 1 - 6
...
const char chr_f32_61[] =         // 3 bytes per row
{
           // row 1 - 4
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00,    // row 5 - 8
...
const char chr_f32_62[] =         // 3 bytes per row
{
           // row 1 - 4
...
const char chr_f32_63[] =         // 2 bytes per row
{
           // row 1 - 6
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,    // row 7 - 12
...
const char chr_f32_64[] =         // 3 bytes per row
{
           // row 1 - 4
...
const char chr_f32_65[] =         // 3 bytes per row
{
           // row 1 - 4
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00,    // row 5 - 8
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,    // row 9 - 12
...
const char chr_f32_66[] =         // 2 bytes per row
{
           // row 1 - 6
...
const char chr_f32_67[] =         // 3 bytes per row
{
           // row 1 - 4
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00,    // row 5 - 8
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,    // row 9 - 12
...
const char chr_f32_68[] =         // 3 bytes per row
{
           // row 1 - 4
        0x00, 0x00, 0x00, 0x30, 0x00, 0x00,    // row 5 - 8
        0x30, 0x00, 0x00, 0x30, 0x00, 0x00, 0x30, 0x00, 0x00, 0x30, 0x00, 0x00,    // row 9 - 12
...
const char chr_f32_69[] =         // 2 bytes per row
{
           // row 1 - 6
...
const char chr_f32_6A[] =         // 2 bytes per row
{
           // row 1 - 6
        0x00, 0x00, 0x30, 0x00, 0x30, 0x00, 0x30, 0x00, 0x00, 0x00, 0x00, 0x00,    // row 7 - 12
        0x30, 0x00, 0x30, 0x00, 0x30, 0x00, 0x30, 0x00, 0x30, 0x00, 0x30, 0x00,    // row 13 - 18
...
const char chr_f32_6B[] =         // 2 bytes per row
{
           // row 1 - 6
...
const char chr_f32_6C[] =         // 2 bytes per row
{
           // row 1 - 6
        0x00, 0x00, 0x30, 0x00, 0x30, 0x00, 0x30, 0x00, 0x30, 0x00, 0x30, 0x00,    // row 7 - 12
        0x30, 0x00, 0x30, 0x00, 0x30, 0x00, 0x30, 0x00, 0x30, 0x00, 0x30, 0x00,    // row 13 - 18
...
const char chr_f32_6D[] =        // 4 bytes per row
{
           // row 1 - 3
           // row 4 - 6
...
const char chr_f32_6E[] =         // 3 bytes per row
{
           // row 1 - 4
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00,    // row 5 - 8
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,    // row 9 - 12
...
const char chr_f32_6F[] =         // 3 bytes per row
{
           // row 1 - 4
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00,    // row 5 - 8
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,    // row 9 - 12
...
const char chr_f32_70[] =         // 3 bytes per row
{
           // row 1 - 4
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00,    // row 5 - 8
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,    // row 9 - 12
...
const char chr_f32_71[] =         // 3 bytes per row
{
           // row 1 - 4
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00,    // row 5 - 8
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,    // row 9 - 12
...
const char chr_f32_72[] =         // 2 bytes per row
{
           // row 1 - 6
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,    // row 7 - 12
...
const char chr_f32_73[] =         // 2 bytes per row
{
           // row 1 - 6
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,    // row 7 - 12
...
const char chr_f32_74[] =         // 2 bytes per row
{
           // row 1 - 6
        0x00, 0x00, 0x00, 0x00, 0x30, 0x00, 0x30, 0x00, 0x30, 0x00, 0x30, 0x00,    // row 7 - 12
...
const char chr_f32_75[] =         // 3 bytes per row
{
           // row 1 - 4
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00,    // row 5 - 8
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,    // row 9 - 12
...
const char chr_f32_76[] =         // 2 bytes per row
{
           // row 1 - 6
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,    // row 7 - 12
...
const char chr_f32_77[] =         // 3 bytes per row
{
           // row 1 - 4
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00,    // row 5 - 8
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,    // row 9 - 12
...
const char chr_f32_78[] =         // 2 bytes per row
{
           // row 1 - 6
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,    // row 7 - 12
...
const char chr_f32_79[] =         // 2 bytes per row
{
           // row 1 - 6
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,    // row 7 - 12
...
const char chr_f32_7A[] =         // 2 bytes per row
{
           // row 1 - 6
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,    // row 7 - 12
...
const char chr_f32_7B[] =         // 2 bytes per row
{
           // row 1 - 6
...
const char chr_f32_7C[] =         // 2 bytes per row
{
           // row 1 - 6
...
const char chr_f32_7D[] =         // 2 bytes per row
{
           // row 1 - 6
...
const char chr_f32_7E[] =        // 3 bytes per row
{
           // row 1 - 3
           // row 4 - 6
...
const char chr_f32_7F[] =         // 1 byte per row
{
        0x00, 0x00, 0x00, 0x00, 0x00,    // row 1 - 11
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,    // row 12 - 22
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00           // row 23 - 32
...
const char* const chrtbl_f32[96] =       // character pointer table
{
