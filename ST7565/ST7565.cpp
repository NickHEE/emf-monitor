...
ST7565::ST7565(PinName SID, PinName SCLK, PinName A0, PinName RST, PinName CS)
{
...
void ST7565::st7565_init(void) {
	spi = new SPI(D11, NC, D13); // create new SPI instance and initialise
    spi->format(8,0);         // 8 bits, Mode 0
    spi->frequency(20000000);  // SPI clock frequency  
    
    // set up other pins as required
    cs = new DigitalOut(D10,1);
    a0 = new DigitalOut(D9, 0);
	rst= new DigitalOut(D8, 1);
	
	
  // toggle RST low to reset; CS low so it'll listen to us
  cs->write(0);
  // CONSIDER MAKING SO THIS IS ONLY LOW WHEN TRANSMITTING SOMETHING
